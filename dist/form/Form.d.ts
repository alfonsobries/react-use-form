import { AxiosError, AxiosInstance, AxiosProgressEvent, AxiosRequestConfig, AxiosResponse, Method } from 'axios';
...
declare class Form<Data extends Record<string, any>> {
    ...
    submit<T = any>(method: Method, url: string, config?: AxiosRequestConfig): Promise<AxiosResponse<T>>;
